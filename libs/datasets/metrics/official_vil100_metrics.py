...
class LaneEval(object):
    ...
    @staticmethod
    def calculate_return(pre_dir_name, json_dir_name, logger=None):
        ...
        fn = fn / num
        print_log(
            f"Accuracy: {accuracy:.4f}, FP: {fp:.4f}, FN: {fn:.4f}", logger=logger
        )
        return accuracy, fp, fn


def official_vil100_line_metrics(pred_dir, json_anno_dir, logger=None):
