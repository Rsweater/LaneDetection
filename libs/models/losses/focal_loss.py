# Adapted from: https://github.com/zkyseu/O2SFormer/blob/main/dnlane/models/losses/focal_loss.py
...
from mmdet.models.losses.focal_loss import py_focal_loss_with_prob,py_sigmoid_focal_loss,sigmoid_focal_loss
