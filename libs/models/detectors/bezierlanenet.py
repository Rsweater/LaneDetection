...
class BezierLaneNet(SingleStageDetector):
    ...
    def forward_train(self, img, img_metas, **kwargs):
        ...
        Args:
            ...
            gt_lanes (List):  List[(N_lanes0, num_control_points, 2), (N_lanes1, num_control_points, 2), ...]
            # gt_labels (List): List[(N_lanes0, ), (N_lanes1, ), ...]
            gt_masks (Tensor): (B, H, W)
        ...
        losses = self.bbox_head.forward_train(x, f, img_metas, **kwargs)
        return losses
